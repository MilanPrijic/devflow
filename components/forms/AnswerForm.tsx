...
import {AnswerSchema} from "@/lib/validaitons";
...
const AnswerForm = ({ questionId, questionTitle, questionContent }: Props) => {
    ...
    const generateAIAnswer = async () => {
        ...
        try {
            ...
            toast.success("AI generated your answer successfully!");

        } catch (error) {
            return toast(error instanceof Error ? error.message : "There was a problem with your request!");
        } finally {
