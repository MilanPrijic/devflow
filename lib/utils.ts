...
export const techDescriptionMap: { [key: string]: string } = {
    ...
    postgresql: "PostgreSQL is a robust open-source relational database with advanced features and strong SQL compliance.",
    aws: "AWS is a comprehensive cloud platform offering a wide range of services for deployment, storage, and more.",
    swift: "Swift is a powerful and intuitive programming language developed by Apple for building apps on its platforms like iOS, macOS, watchOS, and tvOS.",
    objectivec: "Objective-C is an object-oriented programming language that extends the C language, adding Smalltalk-style message passing.",
};
