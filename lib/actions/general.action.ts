...
import {GlobalSearchSchema} from "@/lib/validaitons";
...
export async function globalSearch(params: GlobalSearchParams) {
    try {
        ...
        const modelsAndTypes = [
            { model: DTOQuestion, searchField: "title", type: "question" },
            { model: DTOUser, searchField: "name", type: "user" },
            { model: DTOAnswer, searchField: "content", type: "answer" },
            { model: DTOTag, searchField: "name", type: "tag" },
        ];
